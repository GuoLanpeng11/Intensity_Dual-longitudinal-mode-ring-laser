...
i1sita4433=aT11+aT22+aT32+aT41;


bv11=complex(R,omiga0-nu4);
bv12=complex(Ra,nu3-nu4);
bv13=complex(R,omiga0-nu4);
bv21=bv11;
bv22=bv12;
bv23=complex(R,nu3-omiga0);
bv31=bv11;
bv32=complex(Rb,nu3-nu4);
bv33=bv23;
bv41=bv11;
bv42=bv32;
bv43=bv13;
...
i1sita4334=0;%bT13+bT23+bT33+bT43;
...
i2sita4433=cT11+cT22+cT32+cT41;



dv11=complex(R,omiga1-nu4);
dv12=complex(Ra,nu3-nu4);
dv13=complex(R,omiga1-nu4);
dv21=dv11;
dv22=dv12;
dv23=complex(R,nu3-omiga1);
dv31=dv11;
dv32=complex(Rb,nu3-nu4);
dv33=dv23;
dv41=dv11;
dv42=dv32;
dv43=dv13;
...
i2sita4334=0;%dT13+dT23+dT33+dT43;

i1sita43=imag(i1sita4433+i1sita4334);
i2sita43=imag(i2sita4433+i2sita4334);
asita43=0.25*ra*rb*nu*B/(Q*imag(Z(r))).*(0.53.*i1sita43+0.47.*i2sita43);
end