...
i1sita3344=aT11+aT22+aT32+aT41;



bv11=complex(R,omiga0-nu3);
bv12=complex(Ra,nu4-nu3);
bv13=complex(R,omiga0-nu3);
bv21=bv11;
bv22=bv12;
bv23=complex(R,nu4-omiga0);
bv31=bv11;
bv32=complex(Rb,nu4-nu3);
bv33=bv23;
bv41=bv11;
bv42=bv32;
bv43=bv13;
...
i1sita3443=0;%bT13+bT23+bT33+bT43;
...
i2sita3344=cT11+cT22+cT32+cT41;




dv11=complex(R,omiga1-nu3);
dv12=complex(Ra,nu4-nu3);
dv13=complex(R,omiga1-nu3);
dv21=dv11;
dv22=dv12;
dv23=complex(R,nu4-omiga1);
dv31=dv11;
dv32=complex(Rb,nu4-nu3);
dv33=dv23;
dv41=dv11;
dv42=dv32;
dv43=dv13;
...
i2sita3443=0;%dT13+dT23+dT33+dT43;


i1sita34=imag(i1sita3344+i1sita3443);
i2sita34=imag(i2sita3344+i2sita3443);
asita34=0.25*ra*rb*nu*B/(Q*imag(Z(r))).*(0.53.*i1sita34+0.47.*i2sita34);
end