...
i1sita1111=aT12+aT21+aT31+aT42;


bv11=complex(R,omiga1-nu1);
bv12=ra;
bv13=complex(R,omiga1-nu1);
bv21=bv11;
bv22=bv12;
bv23=complex(R,nu1-omiga1);
bv31=bv11;
bv32=rb;
bv33=bv23;
bv41=bv11;
...
i2sita1111=bT12+bT21+bT31+bT42;

i1sita11=imag(i1sita1111);
i2sita11=imag(i2sita1111);
asita11=0.25*ra*rb*nu*B/(Q*imag(Z(r))).*(0.53.*i1sita11+0.47.*i2sita11);
%plot(nu1-(omiga0+omiga1)/2,asita11,'linewidth',1.5);
end