...
i1sita4444=aT12+aT21+aT31+aT42;



bv11=complex(R,omiga1-nu4);
bv12=ra;
bv13=complex(R,omiga1-nu4);
bv21=bv11;
bv22=bv12;
bv23=complex(R,nu4-omiga1);
bv31=bv11;
bv32=rb;
bv33=bv23;
bv41=bv11;
bv42=bv32;
bv43=bv13;
bT12=0;%-1./bv12.*(-2/(k1*u1).*(bv11./(k1*u1).*Z1(bv11)-1i));
bT21=1./bv22.*(Z1(bv21)+Z1(bv23))./(bv21+bv23);
bT31=1./bv32.*(Z1(bv31)+Z1(bv33))./(bv31+bv33);
bT42=0;%-1./bv42.*(-2/(k1*u1).*(bv41./(k1*u1).*Z1(bv41)-1i));
i2sita4444=bT12+bT21+bT31+bT42;

i1sita44=imag(i1sita4444);
i2sita44=imag(i2sita4444);
asita44=0.25*ra*rb*nu*B/(Q*imag(Z(r))).*(0.53.*i1sita44+0.47.*i2sita44);
