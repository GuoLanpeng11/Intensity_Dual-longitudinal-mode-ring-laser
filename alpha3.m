...
r=128e6;;
R=r.*ones(1,201);   
x=complex(R,omiga0-nu3);  
i1alpha3=0.5.*imag(Z(x))*omiga0*B/(2*Q1*imag(Z(r)));

x1=complex(R,omiga1-nu3); 
i2alpha3=0.5.*imag(Z1(x1))*omiga0*B/(2*Q2*imag(Z1(r)));

aalpha3=0.53.*i1alpha3+0.47.*i2alpha3-omiga0/2*Q1;
